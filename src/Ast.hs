...
data Expr = VarExpr Var
          ...
          | OpExpr { oper :: Op, lhs :: Expr, rhs :: Expr, pos :: Pos}
          | RecordExpr { fields :: [(Symbol, Expr, Pos)], typ :: Symbol, pos :: Pos }
          | SeqExpr [Expr]
          | AssignExpr { vvar :: Var, expr :: Expr, pos :: Pos }
          | IfExpr  { test :: Expr, thene :: Expr, els :: Maybe Expr, pos :: Pos }
          | WhileExpr { test :: Expr, body :: Expr, pos :: Pos }
          | ForExpr { var :: Symbol, escape :: Bool,
                     begin :: Expr, end :: Expr, body :: Expr, pos :: Pos }
          | BreakExpr Pos
...
data Dec = FunctionDec [FuncDec]
         | VarDec { name' :: Symbol, escape' :: Bool,
                    typ' :: Maybe Symbol, init' :: Expr, pos' :: Pos }
...
data FuncDec = FuncDec { name :: Symbol, params :: [Field],
                         result :: Maybe Symbol, func_body :: Expr, func_pos :: Pos }
               deriving(Show)
